...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO dosen (namaDosen,NID,Alamat,MataKuliah) VALUES('$nama','$nid','$alamat','$mata_kuliah')";
...
<body class="">
    <h1 class="text-center">Tambah Data Dosen LP3I</h1>
        ...
        <div class="col">
            <form action="" method="POST" class="border p-4 rounded shadow">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" for="" name="mata_kuliah" class="form-control" max="20" required>
                </div>
